    ...
    <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6 mt-7 max-w-full md:max-w-6xl w-full px-2 sm:px-4 md:px-0">
              ...
              <span className="h-[1.5px] w-[42px] bg-white block"></span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full">
                  ...
                  <div>
                    <label htmlFor="email" className="block text-lg md:text-xl font-medium text-gray-700 dark:text-gray-300 mb-2 transition-colors duration-300">
                      Email Address
                    </label>
                    <input
                      type="email"
                ...
                <div>
                  <label htmlFor="company" className="block text-lg md:text-xl font-medium text-gray-700 dark:text-gray-300 mb-2 transition-colors duration-300">
                    Company
                  </label>
                  <input
                    type="text"
              ...
              <span className="h-[1.5px] w-[42px] bg-white block"></span>
                ...
                <div>
                  <label htmlFor="message" className="block text-lg md:text-xl font-medium text-gray-700 dark:text-gray-300 mb-2 transition-colors duration-300">
                    How can we help?
                  </label>
                  <textarea
                    id="message"
